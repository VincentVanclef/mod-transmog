-- RTG Transmog character-database base schema.
-- Target database: CHARACTERS
-- Forward migrations remain in data/sql/updates/char for existing installs.
...
CREATE TABLE IF NOT EXISTS `custom_transmogrification` (
  ...
  PRIMARY KEY (`GUID`),
  KEY `idx_owner` (`Owner`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='RTG applied item appearances';
